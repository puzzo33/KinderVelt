...
class Knowledge:
    ...
    def active_platforms(self) -> list[dict]:
        return [p for p in self.funding_platforms if p.get("active")]
...
def load_knowledge(root: Path) -> Knowledge:
    ...
    k = Knowledge(
        ...
        funding_platforms=org.get("funding_platforms", []),
